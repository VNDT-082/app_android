        ...
        if($sdtErr=="")
        {
            ...
            if($TaiKhoan!=null)
            {
                ...
                if($TaiKhoan->LoaiTaiKhoan==0)
                {
                    ...
                    if($NguoiDung!=null)
                    {
                        $MatKhau=$random_number = rand(100000, 999999);
                        $TaiKhoan->MatKhau=password_hash($MatKhau, PASSWORD_DEFAULT);
                        $kq=$TaiKhoan->DoiMatKhauMotTaiKhoanKhachHang();
                        $ketqua=guimailRessetPass($NguoiDung->Email,$NguoiDung->TenNguoiDung,$MatKhau);
...
<body style="font-family: 'Times New Roman', Times, serif;">
    <div class="container_Login">
        ...
        <div class="container" style="margin-top: 120px;">
            ...
            <div class="col-md-6">
                <div class="formLogin">
                    <h6 class="h6_">Lấy lại mật khẩu</h6>
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            <input type="checkbox" name="show_pass" onclick="myFunction()" disabled>
                        ...
                        <br/>
                        <div>
                            <button type="submit" name="submit" class="btn btn-primary form-control">Lấy lại mật khẩu</button>
                        </div>
                    </form>
                    <br/>
                    <div class="row">
